...
echo "   - OpenSSH                 : 4443, 22"  | tee -a log-install.txt
echo "   - OpenVPN                 : TCP 1194, UDP 2200, SSL 990"  | tee -a log-install.txt
echo "   - Stunnel5                : 4443, 445, 777"  | tee -a log-install.txt
echo "   - Dropbear                : 4443, 109, 143"  | tee -a log-install.txt
...
echo "   - XRAYS Vmess TLS         : 6443"  | tee -a log-install.txt
echo "   - XRAYS Vmess None TLS    : 82"  | tee -a log-install.txt
echo "   - XRAYS Vless TLS         : 6443"  | tee -a log-install.txt
echo "   - XRAYS Vless None TLS    : 82"  | tee -a log-install.txt
echo "   - XRAYS Trojan            : 2083"  | tee -a log-install.txt
echo "   - Websocket TLS           : 4443"  | tee -a log-install.txt
echo "   - Websocket None TLS      : 8888"  | tee -a log-install.txt
